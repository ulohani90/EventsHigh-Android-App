...
public class EventRequest extends JsonRequest<Event> {
     ...
     */
    public static void submit(BaseActivity activity, Uri eventUri, Priority priority,
        ...
        EventRequest request = new EventRequest(activity, url, city, priority, listener, errorListener);
     ...
     */
    public EventRequest(BaseActivity activity, String url, City city, Priority priority,
                        Listener<Event> listener, ErrorListener errorListener) {
    ...
    protected Response<Event> parseNetworkResponse(NetworkResponse response) {
        new ReportTimingTask(activity, "event").execute(response.networkTimeMs);
