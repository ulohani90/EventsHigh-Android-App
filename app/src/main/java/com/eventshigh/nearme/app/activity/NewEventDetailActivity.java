            ...
            if (checkIfKeyHasValue("is_live_dhol", configMap)) {
                ...
                String finalValue = (value.equalsIgnoreCase("Yes") ||
                        ...
                        ((value.equalsIgnoreCase("No") ||
                                value.equalsIgnoreCase("false")) ? "No" : value);
                isKeyAdded = true;
                addPartyVenue(partyLayoutCount, childCount, "Live Dhol", finalValue, "party_info_layout_", "party_info_textview_");
            }
            if (checkIfKeyHasValue("is_rain_dance", configMap)) {
                ...
                String finalValue = (value.equalsIgnoreCase("Yes") ||
                        ...
                        ((value.equalsIgnoreCase("No") ||
                                value.equalsIgnoreCase("false")) ? "No" : value);
                isKeyAdded = true;
                addPartyVenue(partyLayoutCount, childCount, "Rain Dance", finalValue, "party_info_layout_", "party_info_textview_");
            }
