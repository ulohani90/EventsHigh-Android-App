...
class FirestackDBReference {
  ...
  public DatabaseReference getDatabaseRef() {
    return FirebaseDatabase.getInstance(FirebaseApp.getInstance("organizer_chat")).getReference(mPath);
  }
...
class FirestackDatabaseModule extends ReactContextBaseJavaModule {
  ...
  public void enablePersistence(
    ...
    final Callback callback) {
      try {
        FirebaseDatabase.getInstance(FirebaseApp.getInstance("organizer_chat"))
  ...
  private DatabaseReference getDatabaseReferenceAtPath(final String path) {
    DatabaseReference mDatabase = FirebaseDatabase.getInstance(FirebaseApp.getInstance("organizer_chat")).getReference(path);
    return mDatabase;
  }
